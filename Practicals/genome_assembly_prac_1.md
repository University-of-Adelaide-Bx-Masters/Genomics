...
These tools all do more or less the same job (ie. long read assembly) but with differences in their underlying algorithms and hence, will often give different results even with the same data and with large variation in computational requirements and runtime.  
